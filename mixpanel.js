/*
    ...
    Adaptation updated in 2016 by Mike Gresham baed on commit
      https://github.com/mixpanel/mixpanel-node/commit/0a0450ccc77322bb3924685d0273f4a1b04ca51a
    ...
    */
    metrics.send_request = function(endpoint, data, callback) {
        ...
        Parse.Cloud.httpRequest({
            url: metrics.config.port ? [metrics.config.host,":",metrics.config.port].join("") : metrics.config.host,
            params: request_data
    ...
    metrics.people = {
        ...
        */
        set_once: function(distinct_id, prop, to, modifiers, callback) {
            ...
            return this._set(distinct_id, $set, callback, modifiers);
        },
